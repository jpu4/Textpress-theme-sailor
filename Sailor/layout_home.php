				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="main-slider" class="main-slider flexslider">
							<ul class="slides">
								<li>
									<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/slides/flexslider/1.jpg" alt="" />
								...
								<li>
									<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/slides/flexslider/2.jpg" alt="" />
									<div class="flex-caption">
								...
								<li>
									<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/slides/flexslider/3.jpg" alt="" />
									<div class="flex-caption">
										<h3>Clean & Fast</h3>
							...
							<div class="col-sm-6 col-lg-6">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="one">
										<p><img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/dummy1.jpg" class="pull-left" alt="" />
									...
									<div class="tab-pane" id="two">
										<p><img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/dummy1.jpg" class="pull-right" alt="" /> Tale dolor mea ex, te enim assum suscipit cum, vix aliquid omittantur in. Duo eu cibo dolorum menandri, nam sumo dicit admodum ei. Ne mazim commune honestatis cum, mentitum phaedrum sit
											et.
										</p>
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="grid-container" class="cbp-l-grid-projects">
							<ul>
								<li class="cbp-item graphic">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/1.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/1big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Dashboard<br>by Paul Flavius Nechita">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item web-design logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/2.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/2big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="World Clock Widget<br>by Paul Flavius Nechita">view larger</a>
												</div>
											</div>
										</div>
									</div>
								...
								<li class="cbp-item graphic logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix']; ?>/themes/Sailor/img/works/3.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item web-design graphic">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix']; ?>/themes/Sailor/img/works/4.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item identity web-design">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/5.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item identity web-design">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/6.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item graphic logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/7.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
								...
								<li class="cbp-item graphic logo">
									<div class="cbp-caption">
										<div class="cbp-caption-defaultWrap">
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/8.jpg" alt="" />
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">

													<a href="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/works/8big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Seemple* Music for iPad<br>by Tiberiu Neamu">view larger</a>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="cbp-l-loadMore-button">
							<a href="<?php echo $global['assets.prefix'];?>/themes/Sailor/ajax/loadMore.html" class="cbp-l-loadMore-button-link">LOAD MORE</a>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo"src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/clients/logo1.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo"src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/clients/logo2.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo"src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/clients/logo3.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo"src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/clients/logo4.png" class="img-responsive" />
					</div>

					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo"src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/clients/logo5.png" class="img-responsive" />
					</div>
					<div class="col-xs-6 col-md-2 aligncenter client">
						<img alt="logo"src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/clients/logo6.png" class="img-responsive" />
					</div>
