					...
					<div class="col-lg-8">
						<article>
							<div class="post-image">
								...
								<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/dummies/blog/img1.jpg" alt="" class="img-responsive" />
							</div>
							<p>
						...
						<article>
							<div class="post-slider">
								...
								<div id="post-slider" class="postslider flexslider">
									<ul class="slides">
										<li>
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/dummies/blog/img1.jpg" alt="" />
										</li>
										<li>
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/dummies/blog/img2.jpg" alt="" />
										</li>
										<li>
											<img src="<?php echo $global['assets.prefix'];?>/themes/Sailor/img/dummies/blog/img3.jpg" alt="" />
										</li>
									</ul>
								</div>
								<!-- end flexslider -->
